...
export default async function SmartHealthLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <CategoryButton name={CATEGORY_NAMES.theLeadingDoctors.name} icon="/icon2.png" goTo='/' imageAsTitle="/the-leading-doctors.png" imageAsTitleSecond="/the-leading-hospitals.png" />
