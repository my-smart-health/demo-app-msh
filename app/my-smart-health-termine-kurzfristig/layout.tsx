...
export default async function TheLeadingDoctorsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <NewsSmartHealthMedizinButton name={CATEGORY_NAMES.theLeadingDoctors.name} icon="/icon2.png" goTo={CATEGORY_NAMES.theLeadingDoctors.link} imageAsTitle="/the-leading-doctors.png" imageAsTitleSecond="/the-leading-hospitals.png" />
      <NewsSmartHealthMedizinButton name={CATEGORY_NAMES.mySmartHealthTermineKurzfristig.name} goTo='/' imageAsTitle="/termine-kurzfristig-neutral.png" active />
