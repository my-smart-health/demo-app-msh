...
export default async function TheLeadingDoctorsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <CategoryButton name={CATEGORY_NAMES.theLeadingDoctors.name} icon="/icon2.png" goTo={CATEGORY_NAMES.theLeadingDoctors.link} imageAsTitle="/the-leading-doctors.png" imageAsTitleSecond="/the-leading-hospitals.png" />
