  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-3 gap-3 w-full mx-auto max-w-[100%]">
        <MySmartHealth />
        <ProfileSearchToggle />
        <CategoryButton name={CATEGORY_NAMES.theLeadingDoctors.name} goTo={CATEGORY_NAMES.theLeadingDoctors.link} imageAsTitle="/the-leading-doctors.png" imageAsTitleSecond="/the-leading-hospitals.png" />
        <CategoryButton name={CATEGORY_NAMES.mySmartHealthTermineKurzfristig.name} imageAsTitle="/termine-kurzfristig-neutral.png" goTo={CATEGORY_NAMES.mySmartHealthTermineKurzfristig.link} />
