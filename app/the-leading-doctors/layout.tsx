...
export default async function TheLeadingDoctorsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <CategoryButton name={CATEGORY_NAMES.theLeadingDoctors.name} goTo='/' active imageAsTitle="/the-leading-doctors.png" imageAsTitleSecond="/the-leading-hospitals.png" />
